...
export default function FireHalls() {
  ...
  // Updated fire halls data based on LocalWiki Toronto Fire Stations - Removed non-existent stations
  const fireHalls = {
    North: [
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoFooter}>
          ...
          <Text style={styles.infoText}>
            ...
            Non-existent fire hall numbers have been removed for accuracy.
          </Text>
