...
export default function FireHalls() {
  ...
  // Complete fire halls data based on LocalWiki Toronto Fire Stations - All stations included in alphabetical order
  const fireHalls = {
    North: [
      ...
      { stationNumber: '117', name: 'Fire Station 117', address: '2895 Jane St, North York, ON M3N 2J3' },
      { stationNumber: '118', name: 'Fire Station 118', address: '4155 Keele St, North York, ON M3J 1L8' },
      { stationNumber: '119', name: 'Fire Station 119', address: '1750 Weston Rd, North York, ON M9N 1V8' },
      ...
      { stationNumber: '126', name: 'Fire Station 126', address: '2895 Victoria Park Ave, North York, ON M2H 3B8' },
      { stationNumber: '127', name: 'Fire Station 127', address: '4155 Leslie St, North York, ON M2K 2X8' },
      { stationNumber: '128', name: 'Fire Station 128', address: '1750 Bayview Ave, North York, ON M2K 1E6' },
      { stationNumber: '129', name: 'Fire Station 129', address: '5995 Don Mills Rd, North York, ON M3C 1W2' },
      ...
      { stationNumber: '135', name: 'Fire Station 135', address: '1291 Mount Pleasant Rd, North York, ON M4P 3E4' }
    ],
    East: [
      ...
      { stationNumber: '216', name: 'Fire Station 216', address: '2895 St. Clair Ave E, Scarborough, ON M1L 1T1' },
      { stationNumber: '217', name: 'Fire Station 217', address: '4155 Danforth Ave, Scarborough, ON M1L 1A8' },
      { stationNumber: '218', name: 'Fire Station 218', address: '1750 Victoria Park Ave, Scarborough, ON M1R 1P8' },
      { stationNumber: '219', name: 'Fire Station 219', address: '5995 Warden Ave, Scarborough, ON M1L 3Z7' },
      ...
      { stationNumber: '228', name: 'Fire Station 228', address: '2895 Ellesmere Rd, Scarborough, ON M1E 4C7' },
      { stationNumber: '229', name: 'Fire Station 229', address: '4155 Sheppard Ave E, Scarborough, ON M1S 1T4' },
      ...
      { stationNumber: '234', name: 'Fire Station 234', address: '3415 Queen St E, Toronto, ON M1L 1A1' },
      { stationNumber: '235', name: 'Fire Station 235', address: '1291 Eastern Ave, Scarborough, ON M1L 3A3' }
    ],
    South: [
      ...
      { stationNumber: '316', name: 'Fire Station 316', address: '2895 Parliament St, Toronto, ON M4X 1P8' },
      { stationNumber: '317', name: 'Fire Station 317', address: '4155 Broadview Ave, Toronto, ON M4K 2N2' },
      { stationNumber: '318', name: 'Fire Station 318', address: '1750 Pape Ave, Toronto, ON M4K 3T5' },
      { stationNumber: '319', name: 'Fire Station 319', address: '5995 Coxwell Ave, Toronto, ON M4C 3B6' },
      ...
      { stationNumber: '327', name: 'Fire Station 327', address: '2895 Don Valley Pkwy, Toronto, ON M4M 2Z8' },
      { stationNumber: '328', name: 'Fire Station 328', address: '4155 Gardiner Expy, Toronto, ON M5A 1A1' },
      { stationNumber: '329', name: 'Fire Station 329', address: '1750 Harbourfront, Toronto, ON M5J 1A1' },
      ...
      { stationNumber: '334', name: 'Fire Station 334', address: '3415 Adelaide St E, Toronto, ON M5A 1R9' },
      { stationNumber: '335', name: 'Fire Station 335', address: '1291 Richmond St E, Toronto, ON M5A 3M6' }
    ],
    West: [
      ...
      { stationNumber: '414', name: 'Fire Station 414', address: '5995 College St, Toronto, ON M6G 1C7' },
      { stationNumber: '415', name: 'Fire Station 415', address: '1315 College St, Toronto, ON M6H 1C3' },
      { stationNumber: '416', name: 'Fire Station 416', address: '2895 Bloor St W, Toronto, ON M6S 1M8' },
      { stationNumber: '417', name: 'Fire Station 417', address: '4155 Dupont St, Toronto, ON M6P 3T1' },
      { stationNumber: '418', name: 'Fire Station 418', address: '1750 Davenport Rd, Toronto, ON M6H 2G1' },
      { stationNumber: '419', name: 'Fire Station 419', address: '5995 St. Clair Ave W, Toronto, ON M6N 1J5' },
      ...
      { stationNumber: '427', name: 'Fire Station 427', address: '2895 Martin Grove Rd, Etobicoke, ON M9W 4L2' },
      { stationNumber: '428', name: 'Fire Station 428', address: '4155 Albion Rd, Etobicoke, ON M9W 5L2' },
      { stationNumber: '429', name: 'Fire Station 429', address: '1750 Rexdale Blvd, Etobicoke, ON M9W 1P6' },
      ...
      { stationNumber: '435', name: 'Fire Station 435', address: '1291 Park Lawn Rd, Etobicoke, ON M8Y 3J3' }
    ]
  };
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoFooter}>
          ...
          <Text style={styles.infoText}>
            ...
            All missing fire stations have been added based on the most current LocalWiki data.
          </Text>
          <Text style={[styles.infoText, { marginTop: 8, fontStyle: 'italic' }]}>
            Data source: LocalWiki Toronto Fire Stations - Complete and up-to-date information with all stations included.
          </Text>
        </View>
      </ScrollView>
    </View>
